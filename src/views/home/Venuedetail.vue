<template>
  <div class="Venuedetail">
    ...
    <div class="Venuedetail_content">
      ...
      <div class="recommendtitle">推荐场馆</div>
      <div class="recommendVunue">
        <div class="recommendVunue_every" v-for="data in Venue2" :key="data.VENUESID">
...
export default {
  ...
  components: { Map, homeFooter, back },
  mounted () {
    Axios.get(
      `/server/venue/${this.$route.params.myrouteraddressvenue}.json`
    ).then(res => {
      // console.log(res, 11111111111)
      // console.log(this.$route.params.myrouteraddressvenue, '地址')
      ...
      // console.log(this.Venue2, '02020202场馆详情')
